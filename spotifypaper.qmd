...
---
# Introduction
This study utilizes R packages [@citeR] to clean and analyze Spotify playlist data, employing libraries such as **spotifyr** [@citespotifyr], **dplyr** [@citedplyr], **ggplot2** [@citeggplot], and **tidyverse** [@citetidyverse]. The data was retrieved from Spotify's API using the **spotifyr** package [@spotifyr].
...
Bruno Mars has an energy level almost double that of Adele — 0.65 compared to 0.35. Over time, Bruno Mars has maintained a fairly constant level of energy, although the mid-2010s had a dip, then returned to its previous level, before dipping again by the 2020s.  
